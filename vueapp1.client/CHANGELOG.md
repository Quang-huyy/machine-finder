...
- Créez un projet Vue avec create-vite : `npm init --yes vue@latest vueapp1.client -- --eslint `.
- Mettez à jour `vite.config.js` pour configurer le proxy et les certificats.
- Mettez à jour le composant `HelloWorld` pour récupérer et afficher les informations sur la météo.
- Créez le fichier projet (`vueapp1.client.esproj`).
